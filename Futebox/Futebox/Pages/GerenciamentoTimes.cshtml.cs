...
{
    public class GerenciamentoTimesModel : PageModel
    {
        ...
        public GerenciamentoTimesModel(IGerenciamentoTimesService gerenciamentoTimesService, ICacheHandler cacheHandler)
        {
