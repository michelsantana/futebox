...
namespace Futebox.Services
{
    public class PartidasService : IPartidasService
    {
        ...
        public PartidaVM ObterPartida(int idPartida, bool skipCache = false)
        {
        ...
        public IEnumerable<PartidaVM> ObterPartidasPeriodo(bool skipCache = false)
        {
            var hoje = DateTime.Now.ToString("yyyyMMdd");
        ...
        public PartidaVM ConverterEmPartidaVM(FootstatsPartida footstatsPartida)
        {
            ...
            return new PartidaVM()
            {
                ...
                campeonato = CampeonatoUtils.ObterNomeDoCampeonato((Campeonatos)footstatsPartida.idCampeonato),
