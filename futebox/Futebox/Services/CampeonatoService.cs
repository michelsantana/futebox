...
namespace Futebox.Services
{
    public class CampeonatoService : ICampeonatoService
    {
        ...
        readonly ILogger<ICampeonatoService> _logger;
        ...
        public CampeonatoService(ICacheHandler cache, ITimeRepositorio timeRepositorio, IFootstatsService footstatsService, ILogger<ICampeonatoService> logger)
        {
            _cache = cache;
        ...
        //public List<Campeonato> ObterCampeonatos()
        //{
        //    var cacheName = nameof(FootstatsTime);
        //    var resultado = _cache.ObterConteudo<List<FootstatsTime>>(cacheName);
        //    if (resultado == null)
